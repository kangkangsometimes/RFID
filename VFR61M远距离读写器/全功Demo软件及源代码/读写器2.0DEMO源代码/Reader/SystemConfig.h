...
// Construction
public:
	int SetSerialNo(int ReaderNum);
	int QuerySerialNo(int ReaderNum);
	int SetMACAddr(int ReaderNum);
	int QueryMACAddr(int ReaderNum);
	void GetSerialNum();
	void CheckRelay();
...
protected:
	...
	afx_msg void OnSetSnoMacButton();
	afx_msg void OnQuerySnoMacButton();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedBtnAaset();
	afx_msg void OnBnClickedBtnSetlb();
	afx_msg void OnBnClickedBtnGetlb();
	int QueryAutoInterval(void);
	int SetAutoInterval(void);
	int QueryAutoTriggerTagType(void);
	int SetAutoTriggerTagType(void);
	int QueryAutoAreaConfig(void);
	int SetAutoAreaConfig(void);
	afx_msg void OnBnClickedRadioType6b();
	afx_msg void OnBnClickedRadioType6c();
